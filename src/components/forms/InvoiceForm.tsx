...
import ShippingFormPopup from "./invoice_forms/ShippingFormPopup";
import TransportFormPopup from "./invoice_forms/TransportFormPopup";
...
export default function InvoiceForm({ is_update_invoice, pre_invoice_details = null }: any) {
    ...
    const save_invoice_handler = async (agent_incentive_details: any) => {
