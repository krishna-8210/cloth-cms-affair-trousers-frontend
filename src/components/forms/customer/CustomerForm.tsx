...
const CustomerForm = ({modal_title='Create Customer',button_title='Create Customer'}) => {
    ...
    return <>
        ...
        <ModalFormPupup size='5xl' modal_title={modal_title} button_title={button_title} submit_handler={submit_handler}>
            <div className='grid grid-cols-2 w-full gap-2'>
                ...
                <div><Autocomplete  isLoading={!agent_list_slice} label='Select Agent' name='agent_id_ref'>
